...
1.  Check for [localized rendering rules](https://hiking.waymarkedtrails.org/#help-about#help-hikinglocal).
2.  Try to interpret the `osmc:symbol` tag. For details about which parts are understood, see [osmc:symbol rendering rules](https://hiking.waymarkedtrails.org/#help-aboutosmc_symbols.html).
...
The map also supports [relation hierarchies](https://hiking.waymarkedtrails.org/#help-about#help-hierarchies).
...
See the extra [osmc:symbol](https://hiking.waymarkedtrails.org/#help-aboutosmc_symbols.html) tag page for a list of symbols that are supported by Waymarked Trails.
...
-   ![red line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_std.png) _hiking path_, marked with ![diamond](https://hiking.waymarkedtrails.org/#help-aboutimg/yellow_diamond.svg). Tagged with `network=lwn` and `osmc:symbol=yellow:[...]:yellow_diamond`.
-   ![dashed line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_mnt.png) _mountain path_, marked with ![white-red-white](https://hiking.waymarkedtrails.org/#help-aboutimg/white_red_bar.svg). Tagged with `network=lwn` and `osmc:symbol=red:white:red_bar`.
-   ![dotted line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_alp.png) _alpine path_, marked with ![white-blue-white](https://hiking.waymarkedtrails.org/#help-aboutimg/white_blue_bar.svg). Tagged with `network=lwn` and `osmc:symbol=blue:white:blue_bar`.
...
-   ![red line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_std.png) osmc:symbol=yellow:white:yellow\_upper
-   ![dashed line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_mnt.png) osmc:symbol=red:white:red\_bar
-   ![dotted line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_alp.png) osmc:symbol=blue:white:blue\_bar
...
-   ![red line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_std.png) cai\_scale=T
-   ![dashed line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_mnt1.png) cai\_scale=E
-   ![dashed line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_mnt2.png) cai\_scale=EE
-   ![dotted line](https://hiking.waymarkedtrails.org/#help-aboutimg/route_alp.png) cai\_scale=EEA\*
